    ...
    (
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', fontSize: 34, fontWeight: 800, letterSpacing: 2 }}>FANLOG</div>
          <div style={{ display: 'flex', fontSize: 26, opacity: 0.85 }}>Loyalty Card</div>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ display: 'flex', fontSize: 30, opacity: 0.85, letterSpacing: 1 }}>FANLOG SCORE</div>
          <div style={{ display: 'flex', alignItems: 'flex-end' }}>
            <div style={{ display: 'flex', fontSize: 200, fontWeight: 900, lineHeight: 1 }}>{score || '--'}</div>
          </div>
          <div style={{ display: 'flex', fontSize: 48, fontWeight: 800, marginTop: 12 }}>{archetype}</div>
        </div>

        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', fontSize: 40, fontWeight: 700 }}>{handle || '@GUEST'}</div>
